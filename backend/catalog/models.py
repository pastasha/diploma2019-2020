...
class Picture(models.Model):
    ...
    Preview = models.ImageField(upload_to='media/photos/gallery/preview')
    CreationDate = models.DateField(blank=True, default= "0000-00-00")
    IdTechnique = models.ForeignKey(Technique, related_name='tkp', on_delete=models.CASCADE, null=True)
...
class Diploma(models.Model):
    ...
    def __str__(self):
        return self.Title, self.StudentsFIO
...
class Exhibition(models.Model):
    ...
    Preview = models.ImageField(upload_to='media/photos/diploma/preview')
    ...
    Catalog = models.FileField(upload_to='media/files/catalogs')
...
class Methodical(models.Model):
    ...
    Preview = models.ImageField(upload_to='media/photos/methodical-pw')
    Author = models.CharField(max_length=200, help_text="ФИО автора")
    CreationDate = models.DateField(blank=True, default= "0000-00-00")
    Path = models.FileField(upload_to='media/files/methodical')
